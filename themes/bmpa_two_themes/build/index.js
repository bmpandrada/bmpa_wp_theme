...
class Search {
  ...
  constructor() {
    ...
    this.searchTerms = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-term");
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on("keydown", this.keyPressD);
    this.searchTerms.on("keyup", this.typingLogic);
  }

  //Methods
  typingLogic = () => {
    if (this.searchTerms.val() != this.previousValue) {
      clearTimeout(this.typeTimmer);
      if (this.searchTerms.val()) {
        if (!this.spinnerActive) {
          this.resultsDiv.html('<div class="spinner-loader"></div>');
          this.spinnerActive = true;
        }
        this.typeTimmer = setTimeout(this.getResults, 2000);
      } else {
        this.resultsDiv.html("");
        this.spinnerActive = false;
      }
    }
    this.previousValue = this.searchTerms.val();
  };
  getResults = () => {
    this.resultsDiv.html("yeahss");
    this.spinnerActive = false;
  };
  keyPressD = e => {
